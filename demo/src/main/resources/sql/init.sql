...
GO
create table QRTZ_MYORDER(
recodId int identity(1,1) primary key,
toSomeOne varchar(100),
messageDescription varchar(200),
createTime dateTime,
mailaccount varchar(50)

)

select * from dbo.QRTZ_MYORDER;


create database testData1;
create database testData2;
use testData1;

create table Student(
studId bigint identity(1,1) primary key,
studentname varchar(50),
birthday dateTime,
sex int check (sex=1 or sex=0)--0男 1女
...
go
insert into dbo.Student(studentname,birthday,sex) values('wbxingyc',getdate(),0);
use testData1;
insert into dbo.Student(studentname,birthday,sex)values('wbzhongsy','1998-04-04',0);
use testData2;
